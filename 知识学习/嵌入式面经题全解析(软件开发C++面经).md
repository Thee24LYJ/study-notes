...
见[七、排序算法](数据结构与算法/数据结构与算法知识点.md#七、排序算法)
...
详见[归并排序算法](数据结构与算法/排序算法/归并排序算法.md)
...
bootloader 启动过程一般分为两个阶段，详见[二、嵌入式 Linux 系统 boot loader 执行阶段](操作系统/Linux/Linux系统启动流程.md#二、嵌入式%20Linux%20系统%20boot%20loader%20执行阶段)
